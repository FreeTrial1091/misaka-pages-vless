...
// 建议修改为自己的 UUID
let userID = 'c0efa54b-bcf7-4654-a838-d5ede256e53d';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "www.gov.se"

// 用于 CF 网站的代理 IP
const proxyIPs = ["132.226.114.74"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
